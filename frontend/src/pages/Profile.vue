<template>
  <div id="profile">
    <el-menu
      ...
      @select="handleSelect"
    >
      <el-menu-item index="0" :route="{name: 'home'}">回到首页</el-menu-item>
      ...
      <el-submenu index="1" v-show="roles.includes('student')">
        ...
        <el-menu-item index="2-2" :route="{name: 'test'}">我的作业</el-menu-item>
      </el-submenu>
      <el-submenu index="6"  v-show="roles.includes('teacher')">
        ...
        <el-menu-item index="6-2" :route="{name: 'myRoom'}">我的直播间</el-menu-item>
      </el-submenu>
      ...
      <el-submenu index="8"  v-show="roles.includes('admin')">
        <template slot="title">管理中心</template>
        <el-menu-item index="8-1" :route="{name: 'roomManager'}">直播间管理</el-menu-item>
        <el-menu-item index="8-2" :route="{name: 'userManager'}">成员管理</el-menu-item>
      </el-submenu>
