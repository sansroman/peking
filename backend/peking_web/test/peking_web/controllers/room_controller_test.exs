defmodule PekingWeb.RoomControllerTest do
  use PekingWeb.ConnCase

  alias Peking.Rooms

  @create_attrs %{cover: "some cover", desc: "some desc", hot: true, title: "some title"}
  @update_attrs %{cover: "some updated cover", desc: "some updated desc", hot: false, title: "some updated title"}
