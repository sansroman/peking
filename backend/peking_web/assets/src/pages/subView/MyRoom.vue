      ...
      <el-col :span="10">
        ...
        >
          ...
          <el-form-item label="房间封面:">
            ...
            >
              <img v-if="roomData.cover" :src="roomData.cover" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item label="房间名:" prop="title">
            <el-input v-model="roomData.title" size="small"></el-input>
          </el-form-item>
          <el-form-item>
  ...
  methods: {
    handleupload (param) {
      ...
      cos.putObject({
        ...
        if (err) alert('上传失败')
        else this.roomData.cover = `https://liqiu-1251740680.cos.ap-beijing.myqcloud.com/${name}`
      })
    },
    startLive () {
